                            ...
                            <tr
                                ...
                                <td class="border px-6 py-4">
                                    <div class="flex item-center justify-center">
                                        <a href="{{ route('post.edit', $result->id)}}"  class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        ...
                                        <form action="{{ route('post.destroy', $result->id) }}" id="form-delete-{{ $result->id}}"
                                            role="form" method="POST" class="btn-group btn-group-justified">
                                            @csrf
                                            @method('delete')
                                                
                                                <button class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110r" name="delete" type="submit" title="Hapus Data"
